...
(`mypy --strict` clean) and covered by a test suite of 1130 tests
(94.5 % coverage, gate at 90 %). Results are always SI (m, N, Pa) regardless
...
Current status on this branch: **1130 tests passing, 94.5 % coverage**
...
tests/                                       # 1130 tests incl. tests/validation/
